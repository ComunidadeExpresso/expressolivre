...
// 				if( DataLayer.isConcept( links[link], nestedLinks[link] ) )
    ...
    /*
     * RemoveFilter = m�todo para remo��o de objetos por crit�rio, funcionalidade n�o implementada no m�todo remove
     * TODO - A remo��o � feira em tempo real, onde ainda o mesmo n�o suporta remo��o apenas na camada do cliente
...
// // 	if( res = internalUrl.exec( concept ) )
// // 	{
// // 	    //TODO: verificar se a decodificaï¿œï¿œo deve ser feita em cada item do array
// // 	    data = this.decode( concept, data );
// // 	    concept = res[1];
// // 	    decoder = res[2];
// // 	}
// // 
// // 	var bothSides = (typeof oneSide === "undefined"), uris = [];
// // 
// // 	if( notArray = $.type(data) !== "array" )
// // 	    data = [ data ];
// //       //////////////////////////////////////////////////////////////////////////
...
// // 	for( var i = 0; i < data.length; i++ )
// // 	{
// // 	    var URI = uris[i] = this.generateURI( concept );
// // 
// // 	    this.set( concept, URI, data[i], oneSide );
// // 	}
// // 
// // 	return( notArray ? uris[0] : uris );
// //     },
// //      put: function( concept, data ){
// // 
// // 	var decoder = "";
// // 
// // 	if( res = internalUrl.exec( concept ) )
...
// // 	    if( !data[i].URI )
// // 	    {
// // 		uris[ uris.length ] = data[i].URI = this.create( concept, data[i] );
// // 		New[ New.length ] = data[i];
// // 		continue;
// // 	    }
// // 
// // 	    for( var key in data[i] )
// // 		if( klass = this.isReference( concept, key, data[i][key] ) )
// // 		      data[i][key] = this.put( klass + decoder, data[i][key] );
// // 
// // 	    Update[ Update.length ] = this.update( concept, data[i].URI, data[i] );
// // 	}
// // 
// // 	this.report( concept, { "created": New, "updated": Update });
// // 
// // 	return( notArray ? uris[0] : uris );
// //     },
// //     merge: function( concept, current, data ){
// // 
// // 	current = current || {};
// // 
// // 	for( var key in data )
// // 	    current[key] = (klass = this.isReference( concept, key, data[key] )) ? 
// // 			   this.merge( klass, current[key], data[key] ) : data[key];
// // 
// // 	return( current );
// //     },
// // 
// //     isReference: function( concept, key, value ){
// // 
// //       return( ($.type(value) === "object" || 
// // 	       $.type(value) === "array" )? this.links[concept][key] : false );
// // 
// //     },
// //     
// //     set: function( concept, data, URI, mergeable ){
// // 	
// // 	if( URI )
// // 	{
// // 	    var res = this.get( concept, true ) || {};
// // 	    
// // 	    if( mergeable )
// // 		data = this.merge( res[URI] || {}, data );
// // 
// // 	    res[URI] = data;
// // 
// // 	    data = res;
// // 	}
// // 
// // 	return this.store( concept, data );
// //     },    
// // 
// //     create: function( concept, data ){
// // 
// //       if( notArray = ($.type(data) !== "array") )
// // 	    data = [ data ];
// // 
...
// //       for( var i = 0; i < data.length; i++ )
// //       {
// // 	  uris[ uris.length ] = data[i].URI = "javascript://" + (this.counter + i);
// // 
// // 	  this.set( concept, data[i], data[i].URI );
// //       }
// //  
// //       this.set( ":counter", (this.counter += data.length) );
// // 
// //       return notArray ? uris[0] : uris;
// //     },
// // 
// //     update: function( concept, URI, data )
// //     {
// // 	var target = this.check( concept, URI ) || {};
// // 
// // 	target = this.merge( concept, target, data );
// // 
// // 	if( target.URI !== URI )
// // 	    this.remove( concept, URI );
// // 
// // 	this.set( concept, target, target.URI );
// // 
// // 	return( target );
// //     },
// // 
// //     remove: function( concept, URI ){
// // 
// // 	if( !URI )
// // 	    return this.storage.del( concept );
// // 
// // 	var res = this.check( concept );
// // 
// // 	delete res[URI];
// // 	
// // 	this.set( concept, res );
// //     },
// // 
// //     del: function( concept, URI ){
// // 
// // 	this.remove( concept, URI );
// // 
// // 	this.report( concept, { "deleted": { 'URI': URI } });
// //     },
// // 
// //     report: function( concept, changes ){
// // 
// //       this.broadcast( concept, changes.created, changes.updated, changes.deleted );
// // 
// // 	if( changes.created )
// // 	    this.sync( concept, changes.created, 'create' );
// // 	if( changes.updated )
// // 	    this.sync( concept, changes.updated, 'update' );
// // 	if( changes.deleted )
// // 	    this.sync( concept, changes.deleted, 'delete' );
// // 
// //     },
// // 
// // 
// //    sync: function( concept, data, type ){
// // 
// // 	if( $.type(data) !== "array" )
// // 	    data = [ data ];
// // 
...
// // 
// // 	   DataLayer.send( concept, el, type );
// // 
// // 	});
// // 
// //     },
...
// //     
// // 
// //     request: function( concept, URI, filter ){
// // 
// // //       if( startsDoubleDot.test(concept) )
// // // 	  return( false );
// // 
// //       filter = filter || {};
// // 
...
// // 	filter.URI = URI;
// // 
// //       return this.send( concept, filter, "read", true );
// // 
// //     },
// // 
// //     send: function( concept, data, type, wait ){
// // 
// //       switch( type )
// //       {
...
// // 	case "read": type = "GET"; break;
// //       }
// // 
// //       var url = this.basePath + concept;
// // 
// //       var result = [], notArray = false;
// // 
// // //      alert( data.URI );
// // 
// //       if( data.URI && data.URI.indexOf("javascript://") !== 0 )
// // 	  url += "/" + data.URI;
// // 
// //       var callback = function( dt, textStatus, jqXHR ){
// // 
// // 	    if( notArray = (!$.isArray( dt )) )
// // 		dt = [ dt ];
// // 
...
// // 
// // 		if( data.URI )
// // 		    el = DataLayer.update( concept, data.URI, el );
// // 		else
// // 		    DataLayer.set( concept, el, el.URI );
// // 
// // 		result[ result.length ] = el;
// // 		DataLayer.broadcast( concept );
// // 	  });
// //       };
// // 
// //       $.ajax({
...
// // 	  });
// // 
// //       return( notArray ? result[0] || false : result );
// //     },
//     
//     
//     generateURI: function( concept ){
