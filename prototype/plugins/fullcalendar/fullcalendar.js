	...
	function buildSkeleton(maxRowCnt, showNumbers) {
		...
		for(var mi=0; mi<12; mi++){
			...
			s+="<table class='fc-border-separate' style='width:100%' cellspacing='0'>"+
				"<thead>"+
				"<tr><th colspan='7' class='fc-year-monthly-header' >"+opt('monthNames', mi)+"</th></tr>"+ // !k
				"<tr>";
		for (i=0; i<colCnt; i++) {
			s +="<th class='fc-year-month-weekly-head'>"+ opt('dayNamesShortest', i) +"</th>"; // need fc- for setDayID
		}
		s +="</tr>" +
			"</thead>" +
			"<tbody>";
...
function View(element, calendar, viewName) {
	...
	function opt(name, viewNameOverride) {
		...
		//	return smartProperty(v, viewNameOverride || viewName);
			if ((typeof viewNameOverride != 'undefined') || (viewNameOverride) || (viewNameOverride === 0)) 
					return smartProperty(v, viewNameOverride); 
			else 
					return smartProperty(v, viewName); 
		}
		return v;
	}
