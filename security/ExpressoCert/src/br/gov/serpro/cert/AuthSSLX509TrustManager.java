...
public class AuthSSLX509TrustManager implements X509TrustManager {
    ...
    public void checkServerTrusted(X509Certificate[] certificates,String authType) throws CertificateException {
    	...
    	// TODO: Implementar uma caixa de diálogo que pergunta para o usuário se ele quer aceitar o certificado do site
        ...
        try {
        	...
        	switch (JOptionPane.showOptionDialog(null, "Falha na validação do seguinte certificado:\n" +
        			...
        			options, options[0]))
        	{
        		...
        		case 1:
        			...
        			// TODO: Adicionar código para inserir o certificado como um certificado confiável
        			break;
        			// Aceita certificado para esta sessão
