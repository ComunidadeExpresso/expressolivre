...
public class AuthSSLProtocolSocketFactory implements
    ...
    private URL[] truststoreUrls = null;
    private String[] truststorePasswords = null;
     ...
     * @param truststoreUrls URL of the truststore file. May be <tt>null</tt> if HTTPS server
     *        authentication is not to be used.
     * @param truststorePasswords Password to unlock the truststore.
     */
    public AuthSSLProtocolSocketFactory(
        final URL[] truststoreUrls, final String[] truststorePasswords, final Setup setup)
    {
        super();
        this.truststoreUrls = truststoreUrls;
        this.truststorePasswords = truststorePasswords;
        AuthSSLProtocolSocketFactory.setup = setup;
    }

    // TODO: Usar um mapa de keystores e senhas ou algo como KeystoreCredentialsPair
