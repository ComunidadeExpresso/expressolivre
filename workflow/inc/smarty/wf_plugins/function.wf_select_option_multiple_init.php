 ...
 * @access public 
 */
function smarty_function_wf_select_option_multiple_init($params, &$smarty)
{
	$jsFile = $GLOBALS['phpgw_info']['server']['webserver_url'] . '/workflow/js/jscode/wf_select_option_multiple.js';
	$output = <<<EOF
