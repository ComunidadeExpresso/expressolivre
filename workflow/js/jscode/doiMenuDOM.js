...
{
this._items[i]._icon='<td nowrap style="cursor:pointer;cursor:hand;padding-left:'+iIcon+'px;">';}
else
{
...
{
result+='<table class="TMenu'+this._index+'" id="fr_'+this._id+'"';result+=' cellspacing="'+this._cellSpacing+'" style="cursor:pointer;cursor:hand;position:absolute;display:none;">';result+='<tr><td nowrap class="TMMHeader'+this._index+'"';result+=' onclick="onMMHeaderClick(event,'+this._name+')"';result+='>'+this._headerText+'</td></tr>';result+='<tr><td nowrap> </td></tr>';result+='</table>';}
