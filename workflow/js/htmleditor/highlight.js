  ...
  initStyleDefault();
    ...
    this.newState = -1;
		...
		switch (this.type) {
			...
			break;
			case T_EMPTY_LINE:
				this.data = '<span style="padding-left: 1px;"></span>';
			break;
		}
