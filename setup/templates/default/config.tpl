...
<!-- BEGIN body -->
   ...
   <tr class="row_off">
    ...
    <td><input name="newsettings[temp_dir]" value="{value_temp_dir}" size="40">{errtag_temp_dir}</td>
   </tr>
   ...
   <tr class="row_on">
    ...
    <td><input name="newsettings[files_dir]" value="{value_files_dir}" size="40">{errtag_files_dir}</td>
   </tr>
   ...
   <tr class="row_off">
    ...
    <td><input name="newsettings[webserver_url]" value="{value_webserver_url}" size="40">{errtag_webserver_url}</td>
   </tr>
...
<!--
   <tr class="row_off">
    ...
    <td>
     ...
     </select>{errtag_translation_system}
    </td>
   </tr>
-->
   <tr class="row_off">
   ...
   <tr class="row_on">
    ...
    <td><input name="newsettings[hostname]" value="{value_hostname}">{errtag_hostname}</td>
   </tr>

   <tr class="row_off">
    <td>{lang_Enter_your_default_FTP_server}:</td>
    <td><input name="newsettings[default_ftp_server]" value="{value_default_ftp_server}">{errtag_default_ftp_server}</td>
   </tr>
...
<!-- this is not working correct
   <tr class="row_off">
    ...
    <td>
      ...
      </select>{errtag_daytime_port}
    </td>
   </tr>
-->
   <tr class="row_off">
    <td>{lang_Enter_your_HTTP_proxy_server}:</td>
    <td><input name="newsettings[httpproxy_server]" value="{value_httpproxy_server}">{errtag_httpproxy_server}</td>
   </tr>

   <tr class="row_on">
    <td>{lang_Enter_your_HTTP_proxy_server_port}:</td>
    <td><input name="newsettings[httpproxy_port]" value="{value_httpproxy_port}">{errtag_httpproxy_port}</td>
   </tr>

   <tr class="row_off">
    <td>{lang_Enter_your_HTTP_proxy_server_username}:</td>
    <td><input name="newsettings[httpproxy_server_username]" value="{value_httpproxy_server_username}">{errtag_httpproxy_server_username}</td>
   </tr>

   <tr class="row_on">
    <td>{lang_Enter_your_HTTP_proxy_server_password}:</td>
    <td><input name="newsettings[httpproxy_server_password]" value="{value_httpproxy_server_password}">{errtag_httpproxy_server_password}</td>
   </tr>
      
   <tr class="row_off">
    <td>{lang_Enter_your_MemCache_server}:</td>
    <td><input name="newsettings[server_memcache]" value="{value_server_memcache}">{errtag_server_memcache}</td>
   </tr>
   
   <tr class="row_off">
    <td>{lang_Enter_your_MemCache_server_port}:</td>
    <td><input name="newsettings[port_server_memcache]" value="{value_port_server_memcache}">{errtag_port_server_memcache}</td>
   </tr>

<!-- until they are working
   <tr class="row_off">
    <td>{lang_Enter_the_site_username_for_peer_servers}.</td>
    <td><input name="newsettings[site_username]" value="{value_site_username}">{errtag_site_username}</td>
   </tr>

   <tr class="row_on">
    <td>{lang_Enter_the_site_password_for_peer_servers}.</td>
    <td><input type="password" name="newsettings[site_password]" value="{value_site_password}">{errtag_site_password}</td>
   </tr>
-->
...
<!-- from admin -->
   ...
   <tr class="row_off">
    ...
    <td>
     ...
     </select>{errtag_account_repository}
    </td>
   </tr>
...
{hook_sql_passwdhashes}
     </select>{errtag_sql_encryption_type}
    </td>
   </tr>

   <tr class="row_off">
    <td>{lang_Minimum_account_id_(e.g._500_or_100,_etc.)}:</td>
    <td><input name="newsettings[account_min_id]" value="{value_account_min_id}">{errtag_account_min_id}</td>
   </tr>
   <tr class="row_on">
    <td>{lang_Maximum_account_id_(e.g._65535_or_1000000)}:</td>
    <td><input name="newsettings[account_max_id]" value="{value_account_max_id}">{errtag_account_max_id}</td>
   </tr>
   <tr class="row_off">
    <td>{lang_User_account_prefix}:</td>
    <td><input name="newsettings[account_prefix]" value="{value_account_prefix}">{errtag_account_prefix}</td>
   </tr>
   ...
   <tr class="row_on">
    ...
    <td>
      ...
      </select>{errtag_case_sensitive_username}
    </td>
   </tr>
   ...
   <tr class="row_off">
    ...
    <td>
      ...
      </select>{errtag_auto_create_acct}
    </td>
   </tr>
   ...
   <tr class="row_on">
    ...
    <td>
     ...
     </select>{errtag_auto_create_expire}
    </td>
   </tr>

   <tr class="row_off">
    <td>{lang_Add_auto-created_users_to_this_group_('Default'_will_be_attempted_if_this_is_empty.)}:</td>
    <td><input name="newsettings[default_group_lid]" value="{value_default_group_lid}">{errtag_default_group_lid}</td>
   </tr>
   ...
   <tr class="row_off">
     ...
     <td>
      ...
      </select>{errtag_ldap_extra_attributes}
     </td>
    </tr>

   <tr class="row_on">
    <td>{lang_LDAP_Default_homedirectory_prefix_(e.g._/home_for_/home/username)}:</td>
    <td><input name="newsettings[ldap_account_home]" value="{value_ldap_account_home}">{errtag_ldap_account_home}</td>
   </tr>

   <tr class="row_off">
    <td>{lang_LDAP_Default_shell_(e.g._/bin/bash)}:</td>
    <td><input name="newsettings[ldap_account_shell]" value="{value_ldap_account_shell}">{errtag_ldap_account_shell}</td>
   </tr>

   <tr class="row_on">
    <td>{lang_LDAP_host}:</td>
    <td><input name="newsettings[ldap_host]" value="{value_ldap_host}" size="40">{errtag_ldap_host}</td>
   </tr>

   <tr class="row_off">
    <td>{lang_LDAP_accounts_context}:</td>
    <td><input name="newsettings[ldap_context]" value="{value_ldap_context}" size="40">{errtag_ldap_context}</td>
   </tr>

   <tr class="row_on">
    <td>{lang_LDAP_search_filter_for_accounts,_default:_"(uid=%user)",_%domain=eGW-domain}:</td>
    <td><input name="newsettings[ldap_search_filter]" value="{value_ldap_search_filter}" size="40">{errtag_ldap_search_filter}</td>
   </tr>

   <tr class="row_off">
    <td>{lang_LDAP_groups_context}:</td>
    <td><input name="newsettings[ldap_group_context]" value="{value_ldap_group_context}" size="40">{errtag_ldap_group_context}</td>
   </tr>

   <tr class="row_on">
    <td>{lang_LDAP_rootdn} {lang_(searching_accounts_and_changing_passwords)}:</td>
    <td><input name="newsettings[ldap_root_dn]" value="{value_ldap_root_dn}" size="40" autocomplete="off">{errtag_ldap_root_dn}</td>
   </tr>

   <tr class="row_off">
    <td>{lang_LDAP_root_password}:</td>
    <td><input name="newsettings[ldap_root_pw]" type="password" value="{value_ldap_root_pw}" autocomplete="off">{errtag_ldap_root_pw}</td>
   </tr>
...
{hook_passwdhashes}
     </select>{errtag_ldap_encryption_type}
    </td>
   </tr>
   ...
   <tr class="row_on">
    ...
    <td><input name="newsettings[ldap_master_host]" value="{value_ldap_master_host}" size="40">{errtag_ldap_master_host}</td>
   </tr>
   
   <tr class="row_on">
    <td>{lang_LDAP_master_rootdn} <b>{lang_(must_have_access_to_write_on_ldap_directory)}:</b></td>
    <td><input name="newsettings[ldap_master_root_dn]" value="{value_ldap_master_root_dn}" size="40">{errtag_ldap_master_root_dn}</td>
   </tr>

   <tr class="row_off">
    <td>{lang_LDAP_master_root_password}:</td>
    <td><input name="newsettings[ldap_master_root_pw]" type="password" value="{value_ldap_master_root_pw}">{errtag_ldap_master_root_pw}</td>
   </tr>
   ...
   <tr class="row_on">
    ...
    <td><input name="newsettings[ldap_master_whole_root_dn]" value="{value_ldap_master_whole_root_dn}" size="40">{errtag_ldap_master_whole_root_dn}</td>
   </tr>

   <tr class="row_off">
    <td>{lang_LDAP_master_whole_root_password}:</td>
    <td><input name="newsettings[ldap_master_whole_root_pw]" type="password" value="{value_ldap_master_whole_root_pw}">{errtag_ldap_master_whole_root_pw}</td>
   </tr>
   ...
   <tr class="row_on">
    ...
    <td><input name="newsettings[encryptkey]" value="{value_encryptkey}" size="40">{errtag_encryptkey}</td>
   </tr>
...
{hook_encryptmode}
   ...
   <tr class="row_off">
    ...
    <td>
     ...
     </select>{errtag_file_store_contents}
    </td>
   </tr>
   <tr class="row_on">
    <td colspan="2">&nbsp;</td>
