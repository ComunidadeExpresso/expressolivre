...
-->
   ...
   <tr class="row_off">
    ...
    <td><input name="newsettings[server_memcache]" value="{value_server_memcache}"></td>
   </tr>
   
   <tr class="row_off">
    <td>{lang_Enter_your_MemCache_server_port}:</td>
    <td><input name="newsettings[port_server_memcache]" value="{value_port_server_memcache}"></td>
   </tr>
