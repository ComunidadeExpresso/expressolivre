...
<!-- BEGIN user_list -->
   <tr bgcolor="#e6e6e6">
    ...
    <td align="center">
     <select name="users[]" multiple size="8" style="width: 100%">
{users}
     </select>
    </td>
   </tr>
...
<!-- BEGIN admin_list -->
   <tr bgcolor="#e6e6e6">
    ...
    <td align="center">
     <select name="admins[]" multiple size="8" style="width: 100%">
{admins}
     </select>
    </td>
   </tr>
...
<!-- BEGIN group_list -->
   <tr bgcolor="#e6e6e6">
    ...
    <td align="center">
     <select name="ldapgroups[]" multiple size="5" style="width: 100%">
{ldapgroups}
     </select>
    </td>
   </tr>
