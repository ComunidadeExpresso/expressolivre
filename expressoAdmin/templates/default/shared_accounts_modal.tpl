		    ...
		    <input type="hidden" id="sharedAccountsLocation" value="{sharedAccountsLocation}" />
                    <table align="center" style="display: {aclCalendar}">
                        <tbody>
                                ...
                                <tr>
                                    <td>{lang_read}</td><td><input type="checkbox" name="checkAttr" id ="em_input_readCalendar" onclick="return sharemailbox.setCalendaraclfromuser();" /><img title="{lang_this_user_will_can_read_events_at_the_mailbox_calendar}." src="./expressoAdmin/templates/default/images/ajuda.jpg"></td>
				</tr>
				<tr >
                                    <td>{lang_add}</td><td><input type="checkbox" name="checkAttr" id ="em_input_writeCalendar" onclick="return sharemailbox.setCalendaraclfromuser();" /><img title="{lang_this_user_will_can_create_events_at_the_mailbox_calendar}." src="./expressoAdmin/templates/default/images/ajuda.jpg"></td>
				</tr>
				<tr>
                                    <td>{lang_edit}</td><td><input type="checkbox" name="checkAttr" id ="em_input_editCalendar" onclick="return sharemailbox.setCalendaraclfromuser();" /><img title="{lang_this_user_will_can_edit_events_at_the_mailbox_calendar}." src="./expressoAdmin/templates/default/images/ajuda.jpg"></td>
				</tr>
				<tr>
                                    <td>{lang_exclusion}</td><td><input type="checkbox" name="checkAttr" id ="em_input_deleteCalendar" onclick="return sharemailbox.setCalendaraclfromuser();" /><img title="{lang_this_user_will_can_delete_events_at_the_mailbox_calendar}." src="./expressoAdmin/templates/default/images/ajuda.jpg"></td>
                                </tr>
				<tr >
                                    <td>{lang_restrict}</td><td><input type="checkbox" name="checkAttr" id ="em_input_restrictCalendar" onclick="return sharemailbox.setCalendaraclfromuser();" /><img title="{lang_this_user_will_can_read_restrict_events_at_the_mailbox_calendar}." src="./expressoAdmin/templates/default/images/ajuda.jpg"></td>
				</tr>
                            </tbody>
                    </table>
                    <table align="center" style="display: {aclExpressoCalendar}">
                        <tbody>
                                ...
                                <tr>
                                    <td>{lang_read}</td><td><input type="checkbox" name="checkAttr" id ="em_input_readExpressoCalendar" onclick="return sharemailbox.setExpressoCalendaraclfromuser();" /><img title="{lang_this_user_will_can_read_events_at_the_mailbox_calendar}." src="./expressoAdmin/templates/default/images/ajuda.jpg"></td>
				</tr>
				<tr >
                                    <td>{lang_write}</td><td><input type="checkbox" name="checkAttr" id ="em_input_writeExpressoCalendar" onclick="return sharemailbox.setExpressoCalendaraclfromuser();" /><img title="{lang_this_user_will_can_create_events_at_the_mailbox_calendar}." src="./expressoAdmin/templates/default/images/ajuda.jpg"></td>
				</tr>
				<tr>
                                    <td>{lang_exclusion}</td><td><input type="checkbox" name="checkAttr" id ="em_input_deleteExpressoCalendar" onclick="return sharemailbox.setExpressoCalendaraclfromuser();" /><img title="{lang_this_user_will_can_delete_events_at_the_mailbox_calendar}." src="./expressoAdmin/templates/default/images/ajuda.jpg"></td>
                                </tr>
                                <tr >
                                    <td>{lang_freebusy}</td><td><input type="checkbox" name="checkAttr" id ="em_input_freebusyExpressoCalendar" onclick="return sharemailbox.setExpressoCalendaraclfromuser();" /><img title="{lang_this_user_will_can_read_restrict_events_at_the_mailbox_calendar}." src="./expressoAdmin/templates/default/images/ajuda.jpg"></td>
				</tr>
                            </tbody>
                    </table>
                    <br />
                    	...
                    	<tbody>
	                    	...
	                    	<tr>
	                    		...
	                    		<td>
	                    			...
	                    			<img title="{lang_this_user_will_can_read_messages}." src="./expressoAdmin/templates/default/images/ajuda.jpg">
	                    		</td>
	                    	</tr>
	                    	<tr>
	                    		<td>
	                    		...
	                    		<td>
	                    			...
	                    			<img title="{lang_this_user_will_can_delete/move_messages}." src="./expressoAdmin/templates/default/images/ajuda.jpg">
	                    		</td>
	                    	</tr>
	                    	<tr>
	                    		<td>
	                    		...
	                    		<td>
	                    			...
	                    			<img title="{lang_this_user_will_can_create/add_messages}." src="./expressoAdmin/templates/default/images/ajuda.jpg">
	                    		</td>
	                    	</tr>
	                    	<tr>
	                    		<td>
	                    		...
	                    		<td>
	                    			...
	                    			<img title="{lang_this_user_will_can_send_messages}." src="./expressoAdmin/templates/default/images/ajuda.jpg">
	                    		</td>
	                    	</tr>
	                    	<tr>
	                    		<td>
	                    		...
	                    		<td>
	                    			...
	                    			<img title="{lang_allow_create_or_delete_folders_on_this_mailbox}." src="./expressoAdmin/templates/default/images/ajuda.jpg">
	                    		</td>
	                    	</tr>
                    	</tbody>
                	</table>
                <br />
			<button id="bt_add_user" type="button" onClick="javascript:add_user();"><img src="expressoAdmin/templates/default/images/add.png" style="vertical-align: middle;">&nbsp;{lang_add_owner}</button>
			<br /><br />
			<button id="bt_remove_user" type="button" onClick="javascript:remove_user();"><img src="expressoAdmin/templates/default/images/rem.png" style="vertical-align: middle;">&nbsp;{lang_remove_owner}</button><br><br>
		</td>
