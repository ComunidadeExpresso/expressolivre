...
<table border="0" width="80%" cellspacing="4">
	<tr>
		...
		<td width="10%" valign="middle" align="center" bgcolor="#DDDDDD">
			<button type="button" onClick="javascript:add_user();"><img src="expressoAdmin/templates/default/images/add.png" style="vertical-align: middle;" />&nbsp;{lang_add_owner}</button>
			<br /><br />
			<button type="button" onClick="javascript:remove_user();"><img src="expressoAdmin/templates/default/images/rem.png" style="vertical-align: middle;" />&nbsp;{lang_remove_owner}</button>
		</td>
