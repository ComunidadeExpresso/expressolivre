...
<table width="90%" border="0" cellspacing="0" cellpading="0" align="center">
        <tr>
         ...
         <tr>
             ...
             <td align="center">
                <button type="button" onClick="javascript:addUserInLimitSendersRule();"><img src="expressoAdmin/templates/default/images/add.png" style="vertical-align: middle" width="20px" />&nbsp;{lang_add}</button>
                  <br />
                  <br />
                <button type="button" onClick="javascript:removeSelectedsOptions('selectUsersInRule');"><img src="expressoAdmin/templates/default/images/rem.png" style="vertical-align: middle;" width="20px" />&nbsp;{lang_remove}</button>
             </td>
