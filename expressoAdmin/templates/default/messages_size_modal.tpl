...
<table border="0" cellspacing="4">
	<tr>
		...
		<td width="15%" valign="middle" align="center" bgcolor="#DDDDDD">
			<button id="bt_add_user" type="button" onClick="javascript:add_user();"><img src="expressoAdmin/templates/default/images/add.png" style="vertical-align: middle;">&nbsp;{lang_add}</button>
			<br><br>
			<button id="bt_remove_user" type="button" onClick="javascript:remove_user();"><img src="expressoAdmin/templates/default/images/rem.png" style="vertical-align: middle;">&nbsp;{lang_remove}</button>
		</td>
