				...
				<form action="{form_action}" method="POST" name="app_form">
					...
					<tr>
						...
						<td valign="middle" align="center" bgcolor="#DDDDDD">
							<br /><br /><br /><br /><br /><br />
							<button type="button" onClick="javascript:add_user2scl_maillist();"><img src="expressoAdmin/templates/default/images/add.png" style="vertical-align: middle;" >&nbsp;{lang_add_user}</button>
							<br /><br />
							<button type="button" onClick="javascript:remove_user2scl_maillist();"><img src="expressoAdmin/templates/default/images/rem.png" style="vertical-align: middle;" >&nbsp;{lang_remove_user}</button>
						</td>
