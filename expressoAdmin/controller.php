...
require_once '../services/class.servicelocator.php';
	...
	$cExecuteFormReturn = false;
 	...
 	//	Explode action from cExecute function
        ...
        $action_arr =  explode( '.', $_GET['action'], 3 );
		//avoiding undefined offsets
        $app = isset($action_arr[0])? $action_arr[0] : null;
        $class = isset($action_arr[1])? $action_arr[1] : null;
        $method = isset($action_arr[2])? $action_arr[2] : null;
	}
	// NO ACTION
	else
