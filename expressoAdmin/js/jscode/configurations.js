...
/*    var sentence = Element( id ).value;
    ...
    var url = 'expressoAdmin.boconfiguration.searchUsersAndGroupsForSelect&context=' 
   ...
   var fillHandler = function( fill ){
    ...
    optionFind( id, 'selectUsersAndGroups', 'expressoAdmin.boconfiguration.searchUsersAndGroupsForSelect',
...
//     var sentence = Element( id ).value;
// 
//     var url = 'expressoAdmin.boconfiguration.searchInstitutionalAccountsForSelect&context=' 
// 	      + Element( 'selectOrganizationsInstitutionalAccountModal' ).value
// 	      + '&filter=' + sentence;
// 
//     var fillHandler = function( fill ){
...
//     userFinder( sentence, fillHandler, url, 'spanSearchingSender' );
    ...
    optionFind( id, 'selecSenders', 'expressoAdmin.boconfiguration.searchInstitutionalAccountsForSelect',
...
//     var sentence = Element( id ).value;
// 
//     var url = 'expressoAdmin.boconfiguration.searchUsersForSelect&context=' 
...
//     userFinder( sentence, fillHandler, url, 'spanSearching' );
    ...
    optionFind( id, 'selectUsers', 'expressoAdmin.boconfiguration.searchUsersForSelect',
...
//     var sentence = Element( id ).value;
// 
//     var url = 'expressoAdmin.boconfiguration.searchGroupsForSelect&context=' 
...
//     userFinder( sentence, fillHandler, url, 'spanSearching' );
    ...
    optionFind( id, 'selectGroups', 'expressoAdmin.boconfiguration.searchGroupsForSelect',
