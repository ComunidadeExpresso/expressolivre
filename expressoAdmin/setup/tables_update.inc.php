<?php
	...
	* option) any later version.                                               *
	\**************************************************************************/	
	$test[] = '1.2';
	function expressoAdmin_upgrade1_2()
	{
		$GLOBALS['setup_info']['expressoAdmin']['currentver'] = '1.21';
		return $GLOBALS['setup_info']['expressoAdmin']['currentver'];
	}
	
	$test[] = '1.21';
	function expressoAdmin_upgrade1_21()
	{
		...
		$GLOBALS['setup_info']['expressoAdmin']['currentver'] = '1.240';
		return $GLOBALS['setup_info']['expressoAdmin']['currentver'];
	}

	$test[] = '1.240';
	function expressoAdmin_upgrade1_240()
	{
		$GLOBALS['setup_info']['expressoAdmin']['currentver'] = '1.250';
		return $GLOBALS['setup_info']['expressoAdmin']['currentver'];
	}
	
	$test[] = '1.250';
	function expressoAdmin_upgrade1_250()
	{
		...
		$GLOBALS['setup_info']['expressoAdmin']['currentver'] = '1.261';
		return $GLOBALS['setup_info']['expressoAdmin']['currentver'];
	}
	
	$test[] = '1.261';
	function expressoAdmin_upgrade1_261()
	{
		$GLOBALS['setup_info']['expressoAdmin']['currentver'] = '2.0.000';
		return $GLOBALS['setup_info']['expressoAdmin']['currentver'];
	}
	$test[] = '2.0.000';
	function expressoAdmin_upgrade2_0_000()
	{
		$GLOBALS['setup_info']['expressoAdmin']['currentver'] = '2.0.001';
		return $GLOBALS['setup_info']['expressoAdmin']['currentver'];
	}
	$test[] = '2.0.001';
	function expressoAdmin_upgrade2_0_001()
	{
		$GLOBALS['setup_info']['expressoAdmin']['currentver'] = '2.0.002';
		return $GLOBALS['setup_info']['expressoAdmin']['currentver'];
	}	
	$test[] = '2.0.002';
	function expressoAdmin_upgrade2_0_002()
	{
		$GLOBALS['setup_info']['expressoAdmin']['currentver'] = '2.0.003';
		return $GLOBALS['setup_info']['expressoAdmin']['currentver'];
	}	
	$test[] = '2.0.003';
	function expressoAdmin_upgrade2_0_003()
	{
		$GLOBALS['setup_info']['expressoAdmin']['currentver'] = '2.0.004';
		return $GLOBALS['setup_info']['expressoAdmin']['currentver'];
	}		
	$test[] = '2.0.004';
	function expressoAdmin_upgrade2_0_004()
	{
		$GLOBALS['setup_info']['expressoAdmin']['currentver'] = '2.0.005';
		return $GLOBALS['setup_info']['expressoAdmin']['currentver'];
	}
	$test[] = '2.0.005';
	function expressoAdmin_upgrade2_0_005()
	{
		$GLOBALS['setup_info']['expressoAdmin']['currentver'] = '2.0.006';
		return $GLOBALS['setup_info']['expressoAdmin']['currentver'];
	}
	
	$test[] = '2.0.006';
	function expressoAdmin_upgrade2_0_006()
	{
		...
		$GLOBALS['setup_info']['expressoAdmin']['currentver'] = '2.1.000';
		return $GLOBALS['setup_info']['expressoAdmin']['currentver'];
	}
	$test[] = '2.1.000';
	function expressoAdmin_upgrade2_1_000()
	{
		$GLOBALS['setup_info']['expressoAdmin']['currentver'] = '2.2.000';
		return $GLOBALS['setup_info']['expressoAdmin']['currentver'];
	}
	$test[] = '2.2.000';
	function expressoAdmin_upgrade2_2_000()
	{
		$GLOBALS['setup_info']['expressoAdmin']['currentver'] = '2.2.1';
		return $GLOBALS['setup_info']['expressoAdmin']['currentver'];
	}
	$test[] = '2.2.1';
	function expressoAdmin_upgrade2_2_1()
	{
		$GLOBALS['setup_info']['expressoAdmin']['currentver'] = '2.2.2';
		return $GLOBALS['setup_info']['expressoAdmin']['currentver'];
	}
	$test[] = '2.2.2';
	function expressoAdmin_upgrade2_2_2()
	{
		$GLOBALS['setup_info']['expressoAdmin']['currentver'] = '2.2.3';
		return $GLOBALS['setup_info']['expressoAdmin']['currentver'];
	}
	$test[] = '2.2.3';
	function expressoAdmin_upgrade2_2_3()
	{
		$GLOBALS['setup_info']['expressoAdmin']['currentver'] = '2.2.6';
		return $GLOBALS['setup_info']['expressoAdmin']['currentver'];
	}
	$test[] = '2.2.6';
	function expressoAdmin_upgrade2_2_6()
	{
		$GLOBALS['setup_info']['expressoAdmin']['currentver'] = '2.2.8';
		return $GLOBALS['setup_info']['expressoAdmin']['currentver'];
	}	
	$test[] = '2.2.8';
	function expressoAdmin_upgrade2_2_8()
	{
		$GLOBALS['setup_info']['expressoAdmin']['currentver'] = '2.3.0';
		return $GLOBALS['setup_info']['expressoAdmin']['currentver'];
	}	
	$test[] = '2.3.0';
			...
			foreach ($tmp as $index => $right)
	{
 	...
 	{ 
		...
		$GLOBALS['setup_info']['expressoAdmin']['currentver'] = '2.4.0';
 	    return $GLOBALS['setup_info']['expressoAdmin']['currentver']; 
 	}

 	$test[] = '2.4.0';
	function expressoAdmin_upgrade2_4_0()
	{
		$GLOBALS['setup_info']['expressoAdmin']['currentver'] = '2.4.1';
		return $GLOBALS['setup_info']['expressoAdmin']['currentver'];
	}

    	$test[] = '2.4.1';
	function expressoAdmin_upgrade2_4_1()
	{
		$GLOBALS['setup_info']['expressoAdmin']['currentver'] = '2.4.2';
		return $GLOBALS['setup_info']['expressoAdmin']['currentver'];
	}
	$test[] = '2.4.2';
    function expressoAdmin_upgrade2_4_2()
    {
            $GLOBALS['setup_info']['expressoAdmin']['currentver'] = '2.5.0';
            return $GLOBALS['setup_info']['expressoAdmin']['currentver'];
    }

    $test[] = '2.5.0';
    function expressoAdmin_upgrade2_5_0()
    {
...
$$;'
	...
	$test[] = '2.5.1.1';
	function expressoAdmin_upgrade2_5_1_1()
	{
		$GLOBALS['setup_info']['expressoAdmin']['currentver'] = '2.5.2';
		return $GLOBALS['setup_info']['expressoAdmin']['currentver'];
	}
?>
