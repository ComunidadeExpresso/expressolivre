	...
	*  option) any later version.														*
	...
	class uimanagers
	{
		...
		function uimanagers()
		{
			...
			$GLOBALS['phpgw']->js->validate_file('jscode','managers','expressoAdmin');
		}

		function row_action($lang,$link,$manager_lid,$context)
		{	
			return '<a href="'.$GLOBALS['phpgw']->link('/index.php',Array(
				'menuaction' => 'expressoAdmin.uimanagers.'.$link,
				'action'		=>	$lang,
		...
		function list_managers()
		{
			...
			$GLOBALS['phpgw_info']['flags']['app_header'] = $GLOBALS['phpgw_info']['apps']['expressoAdmin']['title'].' - '.lang('List Managers');
			...
			$var = Array(
				'action' 			=> $GLOBALS['phpgw']->link('/index.php','menuaction=expressoAdmin.uimanagers.add_managers'),
				'tr_color'			=> '#DDDDDD',
		...
		function add_managers()
		{
			...
			// Imprime o NavBar
			unset($GLOBALS['phpgw_info']['flags']['nonavbar']);
			$GLOBALS['phpgw_info']['flags']['app_header'] = $GLOBALS['phpgw_info']['apps']['expressoAdmin']['title'].' - '.lang('Add Managers');
			$GLOBALS['phpgw']->common->phpgw_header();
			
			// Seta variaveis javascript necessárias
			$webserver_url = $GLOBALS['phpgw_info']['server']['webserver_url'];
			$scripts_java = '<script type="text/javascript" src="'.$webserver_url.'/expressoAdmin/js/jscode/expressoadmin.js"></script>';
			...
			*/
			...
			$var = Array(
				...
				//'action'				=> $GLOBALS['phpgw']->link('/index.php','menuaction=expressoAdmin.uimanagers.validate'),
				//'action'				=> $GLOBALS['phpgw']->link('/index.php','menuaction=expressoAdmin.bomanagers.add_managers'),
		...
		function delete_managers()
		{
			...
			ExecMethod('expressoAdmin.uimanagers.list_managers');
		}
		...
		function edit_managers()
		{
			...
			// Imprime o NavBar
			unset($GLOBALS['phpgw_info']['flags']['nonavbar']);
			$GLOBALS['phpgw_info']['flags']['app_header'] = $GLOBALS['phpgw_info']['apps']['expressoAdmin']['title'].' - '.lang('Edit Managers');
			$GLOBALS['phpgw']->common->phpgw_header();
