...
class uiconfiguration
{
    ...
    function uiconfiguration()
    {
        ...
        if (function_exists('CreateObject'))
        {
            ...
            $this->boconfiguration = CreateObject('expressoAdmin.boconfiguration');
    		...
    		$GLOBALS['phpgw']->js->validate_file('jscode','configurations','expressoAdmin');
    ...
    { 
        ...
        $GLOBALS['phpgw_info']['flags']['app_header'] = $GLOBALS['phpgw_info']['apps']['expressoAdmin']['title'].' - '.lang('Configurations');
        ...
        if( isset($configsGlobais['expressoMail_block_institutional_comunication']) && $configsGlobais['expressoMail_block_institutional_comunication'] == 'true' )
            $template->set_var('checkedBlockCommunication', 'checked = "true"');
         
        $template->set_var('valueMaximumRecipient', (isset($configsGlobais['expressoAdmin_maximum_recipients'])?$configsGlobais['expressoAdmin_maximum_recipients']:""));
