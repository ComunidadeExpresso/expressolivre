	...
	class uishared_accounts
	{
		...
		{			
			if (function_exists('CreateObject'))
			{
				...
				$GLOBALS['phpgw']->js->validate_file('jscode','shared_accounts','expressoAdmin');
		...
		function index()
		{
			...
			$GLOBALS['phpgw_info']['flags']['app_header'] = $GLOBALS['phpgw_info']['apps']['expressoAdmin']['title'].' - '.lang('shared accounts');
