<?php
	...
	*  option) any later version.														 *
	...
	class uidomains
	{
		...
		function uidomains()
		{
			$this->db = CreateObject('expressoAdmin.db_functions');
		...
		function list_domains()
		{
			...
			$GLOBALS['phpgw_info']['flags']['app_header'] = $GLOBALS['phpgw_info']['apps']['expressoAdmin']['title'].' - '.lang('Samba Domains');
			...
			$var = Array(
				'action'	=> $GLOBALS['phpgw']->link('/index.php','menuaction=expressoAdmin.uidomains.add'),
		...
		function add()
		{
			...
			unset($GLOBALS['phpgw_info']['flags']['noheader']);
			unset($GLOBALS['phpgw_info']['flags']['nonavbar']);
			$GLOBALS['phpgw_info']['flags']['app_header'] = $GLOBALS['phpgw_info']['apps']['expressoAdmin']['title'].' - '.lang('Add Samba Domain');
			$GLOBALS['phpgw']->common->phpgw_header();
			...
			$var = Array(
				'action'		=> $GLOBALS['phpgw']->link('/index.php','menuaction=expressoAdmin.uidomains.validate_data'),
				'back_url'		=> $GLOBALS['phpgw']->link('/index.php','menuaction=expressoAdmin.uidomains.list_domains'),
				'row_on'		=> "#DDDDDD",
				'row_off'		=> "#EEEEEE",
				'color_bg1'		=> "#E8F0F0",
		...
		function validate_data()
		{
			if ($_POST['sambadomainname'] == '')
			{
				...
				ExecMethod('expressoAdmin.uidomains.add');
				return;
			}
			...
			ExecMethod('expressoAdmin.uidomains.list_domains');
			return;
		}
		...
		function row_action($action,$sambadomainname)
		{
			return '<a href="'.$GLOBALS['phpgw']->link('/index.php',Array(
				'menuaction'		=> 'expressoAdmin.uidomains.'.$action,
