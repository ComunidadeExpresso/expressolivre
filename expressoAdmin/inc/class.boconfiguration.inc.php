...
require_once 'class.db_functions.inc.php';
    ...
    class boconfiguration
    {
       ...
       function saveGlobalConfiguration($params)
       {
           ...
           $filter = 'WHERE config_app = \'expressoMail\' AND config_name = \'expressoMail_block_institutional_comunication\'';
           ...
           $filter = 'WHERE config_app = \'expressoMail\' AND config_name = \'expressoAdmin_maximum_recipients\'';
           $fields = array('oid','config_value');
           $rules = $this->soConfiguration->getRuleGlobalInDb($filter, $fields);
       ...
       function getGlobalConfiguratons()
       {
           ...
           $filter = 'WHERE config_app = \'expressoMail\' ';
