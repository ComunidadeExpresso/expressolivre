<?php
	...
	*  option) any later version.														 *
	...
	class bosectors
	{
		...
		function bosectors()
		{
			$this->so = createobject('expressoAdmin.sosectors');
		...
		function create_sector()
		{
			...
			$url = ($GLOBALS['phpgw']->link('/index.php','menuaction=expressoAdmin.uisectors.list_sectors'));
	...
	function save_sector()
		...
		$context = utf8_encode($_POST['context']);
			...
			// Volta para o ListSectors
			ExecMethod('expressoAdmin.uisectors.list_sectors');
		}
