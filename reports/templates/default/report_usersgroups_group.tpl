...
<div align="center">
   <table border="0" width="90%">
    ...
    <tr>
      <td align="left"><form method="POST" action="./index.php?menuaction=reports.uireports_usersgroups.report_usersgroups_group">
  {lang_search}:
 ...
 <div align="center">
  <table border="0" width="90%">
   <tr>
	<form  name="org" method="POST" action="./index.php?menuaction=reports.uireports_usersgroups.report_usersgroups_group_print">
    	<td width="89%">
			<div align="center">
...
<!-- BEGIN row -->
   <tr bgcolor="{tr_color}">
<form name="{formname}" method="POST" action="./index.php?menuaction=reports.uireports_usersgroups.report_usersgroups_group_print">
    <td width="30%">
