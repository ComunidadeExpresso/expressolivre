			...
			<tr>
			  <td colspan="2" align="left">
			  	<div align="right" style="float:right">
					<form name="back" method="post" action="./index.php?menuaction=reports.uireports_users.report_users_group">
		      ...
		      <td width="9%" align="left">				  
				  <div align="right" style="float:left">
					<form action="./index.php?menuaction=reports.uireports_users.report_users_print_pdf" method="post" name="pdf" target="_blank">
	...
	<div align="center">
		<table border="0" width="90%">
			...
			<tr bgcolor="{th_bg}">
				...
				<td width="15%">{lang_report phone}</td>
				<td width="15%">{lang_status}</td>
			</tr>
			{rows}
		</table>
	</div>
