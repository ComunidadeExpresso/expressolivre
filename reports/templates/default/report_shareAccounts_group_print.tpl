			...
			<tr>
			  <td colspan="2" align="left">
			  	<div align="right" style="float:right">
					<form name="back" method="post" action="./index.php?menuaction=reports.uireports_shareAccounts.report_shareAccounts_group">
		      ...
		      <td width="9%" align="left">				  
				  <div align="right" style="float:left">
					<form action="./index.php?menuaction=reports.uireports_shareAccounts.report_shareAccounts_print_pdf" method="post" name="pdf" target="_blank">
