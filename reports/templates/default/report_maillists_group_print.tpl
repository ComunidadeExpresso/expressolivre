   ...
   <div align="center">
			...
			<tr>
			  <td colspan="2" align="left">
			  	<div align="right" style="float:right">
					<form name="back" method="post" action="./index.php?menuaction=reports.uireports_maillists.report_maillists_group">
		      ...
		      <td width="9%" align="left">				  
				  <div align="right" style="float:left">
					<form action="./index.php?menuaction=reports.uireports_maillists.report_maillists_group_print_pdf" method="post" name="pdf" target="_blank">
		...
		<table border="0" width="90%">
			...
			<tr>
		      ...
		      <td width="60%" align="left">{lang_total_maillists}&nbsp;<strong>{cont_maillists}</strong></td>
