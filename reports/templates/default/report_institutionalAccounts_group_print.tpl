			...
			<tr>
			  <td colspan="2" align="left">
			  	<div align="right" style="float:right">
					<form name="back" method="post" action="./index.php?menuaction=reports.uireports_institutionalAccounts.report_institutionalAccounts_group">
		      ...
		      <td width="9%" align="left">				  
				  <div align="right" style="float:left">
					<form action="./index.php?menuaction=reports.uireports_institutionalAccounts.report_institutionalAccounts_print_pdf" method="post" name="pdf" target="_blank">
	...
	<div align="center">
		<table border="0" width="90%">
			...
			<tr bgcolor="{th_bg}">
				...
				<td width="20%">{lang_report email}</td>
				<td width="5%">{lang_status}</td>
				<td width="20%">{lang_participants}</td>
			</tr>
			{rows}
		</table>
	</div>
