...
<div align="center">
   <table border="0" width="90%">
    <tr>
	 	<td align="left">
			<div align="center" class="style2">{lang_Report_of_shared_accounts_of_the_Organization}:<br><br>&nbsp;<font color="blue">{context_display}</font><br><br>
	 	    </div></td>
 	 </tr>
    <tr>
      <td align="left"><form method="POST" action="./index.php?menuaction=reports.uireports_shareAccounts.report_shareAccounts_group">
  {lang_search}:
 ...
 <div align="center">
  <table border="0" width="90%">
   <tr>
	<form  name="org" method="POST" action="./index.php?menuaction=reports.uireports_shareAccounts.report_shareAccounts_group_setor_print">
    	<td width="89%">
			<div align="center">
...
<!-- BEGIN row -->
   <tr bgcolor="{tr_color}">
<form name="{formname}" method="POST" action="./index.php?menuaction=reports.uireports_shareAccounts.report_shareAccounts_group_setor_print">
    <td width="30%">
