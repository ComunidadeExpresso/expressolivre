<!-- BEGIN groups_ldap -->
	...
	<table cellspacing="2" style="border:1px solid #000; margin-top:20px; width: 60%;" align="center">
		<tr>
			<td style='background:#dedede;'>&nbsp;{lang_Servers_ldap}</td>
			<td style='background:#dedede;'>&nbsp;{lang_Edit}</td>
		</tr>
		{value_lists_ldaps}
	</table>
	<br/>
	<table cellspacing="2" style="border:0; width: 60%;" align="center">
		<tr>
			<td><input type="button" onClick="document.location.href='{action_url_back}'" value="{label_Back}"/></td>
		</tr>
	</table>
...
<form method="POST" action="{action_url}">
	<table align="center" width="60%" cellspacing="2" style="border: 1px solid #000000;">
		...
		<tr class="row_on">
			<td colspan="2">{label_serverLdap} : {value_serverLdap} </td>
		</tr>
		<tr class="row_off">
