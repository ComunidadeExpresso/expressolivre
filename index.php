...
if( isset($_GET['menuaction']) )
{
	...
	if( $modulo[0] == 'expressoAdmin' || $modulo[0] == 'calendar' )
	{
		...
		echo '<script type="text/javascript" src="prototype/plugins/jquery/jquery-ui.min.js"></script>';
		echo '<script type="text/javascript" src="prototype/plugins/json2/json2.js"></script>';
		echo '<script type="text/javascript" src="prototype/plugins/ejs/ejs.js"></script>';
		...
		if( $modulo[0] == 'calendar' )
		{
			...
			echo '<script type="text/javascript" src="expressoMail/js/common_functions.js"></script>';
			echo '<script type="text/javascript">userContacts = false; currentTypeContact = ""; REST.get("/usercontacts", false, updateDynamicContact);</script>';
		}
	}
}