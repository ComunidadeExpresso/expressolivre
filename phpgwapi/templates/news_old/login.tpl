...
<!--
 ...
 var news = new News({public_news});
	-->
</script>
</HEAD>
<body scroll="no"  style="overflow:hidden" onLoad="javascript:getLogin();news.start(4000)" bgcolor="#ffffff">
...
<div align="center">
	<div id="conteudo_corpo">
		<div id="superior">
			<div id="news">
				<div id="news_block">				
					<b><div id="news_subject"></div></b><div id="news_content"></div>
				</div>
				<img onmouseover="this.className='news_button_over'" onmouseout="this.className='news_button'" class="news_button" onclick="javascript:news.update('previous')" title="{lang_previous}" src="./phpgwapi/templates/{template}/images/player-previous.png"/>
        	 	<img onmouseover="this.className='news_button_over'" onmouseout="this.className='news_button'" class="news_button" onclick="javascript:news.pause()" title="{lang_pause}" src="./phpgwapi/templates/{template}/images/player-pause.png" id="img_player_pause" />
        	 	<img onmouseover="this.className='news_button_over'" onmouseout="this.className='news_button'" style="display:none" class="news_button" onclick="javascript:news.pause()" title="{lang_resume}" src="./phpgwapi/templates/{template}/images/player-resume.png" id="img_player_resume" />
			 	<img onmouseover="this.className='news_button_over'" onmouseout="this.className='news_button'" class="news_button"  onclick="javascript:news.update('next')" title="{lang_next}" src="./phpgwapi/templates/{template}/images/player-next.png"/>			 			
			</div>
		<div id="login">
      <div align="center">
