...
//		this.clientArea.style.overflow = 'auto';
		...
		this.buttons.xDIV.onclick = function() {_this.close();_this.state = 2;if(document.getElementById("window_QuickCatalogSearch")) document.getElementById("window_QuickCatalogSearch").style.visibility = "hidden";};
...
*/
	...
	dJSWin.prototype.close = function()
	{
		...
		var divBan = document.getElementById('divAppbox');
                divBan.removeAttribute('onclick');
                if (is_ie){
                        divBan.onclick = function(){}; 
                }   
	}
