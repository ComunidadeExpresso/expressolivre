...
<!-- Foi incluído essa parte no evento do form (onsubmit....) e foi incluído a linha de cima para usar o arquivo .js -->
	...
	<tr class="row_on">
		...
		<td>
			<select name="newsettings[cc_ldap_recursive]">
				<option value="false" {selected_cc_ldap_recursive_false}>Não</option>
