...
<input id="cc_contact_grps" type="hidden" value="{cc_contact_grps}">
...
<!-- _GROUPS -->
<div id="cc_contact_groups_tab" class="row_off div_cc_contact_tab" style="position: absolute; visibility: hidden;height:247px;width:498px">
	<table border="0" cellpadding="0" cellspacing="0" align="center" width="100%">
		<tr>
			<td  align="right">
				<table border="0" cellpadding="0" cellspacing="0">
					<tr height="30" class="th">
						<td  align="center">{cc_grps_available}</td>					
					</tr>
					<tr height="30" class="th">
						<td  align="right"><select  id="id_grps_available" multiple name="grps_available[]" style="width:200px" size="10"></select></td>
					</tr>
				</table>
			</td>
			...
			<td  align="left">
				<table border="0" cellpadding="0" cellspacing="0">
					<tr height="30" class="th">
						<td  align="center">{cc_grps_selected}</td>					
					</tr>
					<tr height="30" class="th">
						<td  align="left"><select  id="id_grps_selected" multiple name="grps_selected[]" style="width:200px" size="10"></select></td>
					</tr>
				</table>
			</td>
		</tr>
...
<!-- _BOTTOM BUTTONS -->
<div align="center" id="cc_contact_tab_buttons" style="position: absolute; visibility: hidden; top: 280px; left: 0px; width: 498px; height: 50px; border: 0px solid black">
	...
	<table class="row_off" align="center" width="498px" cellpadding="2" cellspacing="0" border="0">
		<tr>
			<td align="center">
				<input id="cc_contact_save" style="width: 100px; cursor: pointer;" type="button" value="{cc_contact_save}" onclick="javascript:postFullAdd();">
				<input id="cc_contact_reset" style="width: 100px; cursor: pointer;" type="button" value="{cc_contact_reset}" onclick="javascript:resetFullAdd();">
				<input id="cc_contact_cancel" style="width: 100px; cursor: pointer;" type="button" value="{cc_contact_cancel}" onclick="javascript:closeFullAdd();">
			</td>
		</tr>
	</table>
</div>
...
//	Overloading some methods for fix cursor problem in Firefox.
	...
	__f = function(e)
	{
		...
		tabs.addTab({'id': 'cc_contact_tab_1', 
					 ...
					 'selectedClass': 'tab_box_active', 
					 'unselectedClass': 'tab_box'});
		tabs.addTab({'id': 'cc_contact_groups_tab',
					 'name': Element('cc_contact_grps').value,
					 'selectedClass': 'tab_box_active', 
					 'unselectedClass': 'tab_box'});			 
		...
		fullAddWin = new dJSWin({'id': 'cc_full_add_window',
					 ...
					 'include_contents': new Array('cc_contact_tab_0', 'cc_contact_tab_1', 'cc_contact_tab_2','cc_contact_groups_tab','cc_contact_tab_buttons'),
					 'border': true});
