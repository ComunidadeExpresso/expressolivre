<?php
	...
	* option) any later version.                                               *
	...
	$test[] = '2.2.2'; 
 	...
 	$test[] = '2.2.6';
 	function expressoMail1_2_upgrade2_2_6() {
 		$setup_info['expressoMail1_2']['currentver'] = '2.2.8';
 		return $setup_info['expressoMail1_2']['currentver'];
 	}
 	$test[] = '2.2.8';
 	function expressoMail1_2_upgrade2_2_8() {
 		$setup_info['expressoMail1_2']['currentver'] = '2.2.10';
 		return $setup_info['expressoMail1_2']['currentver'];
 	}
 	$test[] = '2.2.10';
 	function expressoMail1_2_upgrade2_2_10() {
 		$setup_info['expressoMail1_2']['currentver'] = '2.3.0';
 		return $setup_info['expressoMail1_2']['currentver'];
 	} 	 	
	$test[] = '2.3.0'; 
 	function expressoMail1_2_upgrade2_3_0() { 
 	    $setup_info['expressoMail1_2']['currentver'] = '2.4.0'; 
 	    return $setup_info['expressoMail1_2']['currentver']; 
 	}
	$test[] = '2.4.0';
	function expressoMail1_2_upgrade2_4_0() {
    	$oProc = $GLOBALS['phpgw_setup']->oProc;            
		...
		$GLOBALS['setup_info']['expressoMail1_2']['currentver'] = '2.4.1';
        return $GLOBALS['setup_info']['expressoMail1_2']['currentver'];
	}
        $test[] = '2.4.1';
	function expressoMail1_2_upgrade2_4_1() {
            $oProc = $GLOBALS['phpgw_setup']->oProc;            
		...
		$GLOBALS['setup_info']['expressoMail1_2']['currentver'] = '2.4.2';
        return $GLOBALS['setup_info']['expressoMail1_2']['currentver'];
	}
	
	$test[] = '2.4.2';
	function expressoMail1_2_upgrade2_4_2() {
            $oProc = $GLOBALS['phpgw_setup']->oProc;
	    $oProc->query('ALTER TABLE mail_attachment RENAME TO expressomail_attachment');
	    $GLOBALS['setup_info']['expressoMail1_2']['currentver'] = '2.4.3';
	    return $GLOBALS['setup_info']['expressoMail1_2']['currentver'];
	}
	
	$test[] = '2.4.3';
	function expressoMail1_2_upgrade2_4_3() {
            $oProc = $GLOBALS['phpgw_setup']->oProc;
	    ...
	    $GLOBALS['setup_info']['expressoMail1_2']['currentver'] = '2.4.4';
	    return $GLOBALS['setup_info']['expressoMail1_2']['currentver'];
	}
	
	$test[] = '2.4.4';
	function expressoMail1_2_upgrade2_4_4() {
            $oProc = $GLOBALS['phpgw_setup']->oProc;
		$oProc->query("DELETE FROM expressomail_label");
	    $oProc->query("ALTER TABLE expressomail_label ADD COLUMN slot bigint not null");
 
	    $GLOBALS['setup_info']['expressoMail1_2']['currentver'] = '2.4.5';
	    return $GLOBALS['setup_info']['expressoMail1_2']['currentver'];
	}
	
	$test[] = '2.4.5';
	function expressoMail1_2_upgrade2_4_5() {
		$oProc = $GLOBALS['phpgw_setup']->oProc;
	    ...
	    $GLOBALS['setup_info']['expressoMail1_2']['currentver'] = '2.4.6';
	    return $GLOBALS['setup_info']['expressoMail1_2']['currentver'];
	}

	/* Registra o hook de validação do administrador*/
	$test[] = '2.4.6';
	function expressoMail1_2_upgrade2_4_6() {
	    $GLOBALS['setup_info']['expressoMail1_2']['currentver'] = '2.4.7';
	    return $GLOBALS['setup_info']['expressoMail1_2']['currentver'];
	}

	$test[] = '2.4.7';
	function expressoMail1_2_upgrade2_4_7() {
		$oProc = $GLOBALS['phpgw_setup']->oProc;
		...
		$GLOBALS['setup_info']['expressoMail1_2']['currentver'] = '2.4.8';
	    return $GLOBALS['setup_info']['expressoMail1_2']['currentver'];
	}
	
	$test[] = '2.4.8';
	function expressoMail1_2_upgrade2_4_8() {
		$oProc = $GLOBALS['phpgw_setup']->oProc;

		$oProc->query("ALTER TABLE expressomail_message_followupflag ADD COLUMN sent smallint not null default 0");

		$GLOBALS['setup_info']['expressoMail1_2']['currentver'] = '2.4.8.1';
	    return $GLOBALS['setup_info']['expressoMail1_2']['currentver'];
	}

    $test[] = '2.4.8.1';
    function expressoMail1_2_upgrade2_4_8_1() {
        $GLOBALS['setup_info']['expressoMail1_2']['currentver'] = '2.4.8.2';
        return $GLOBALS['setup_info']['expressoMail1_2']['currentver'];
    }

	$test[] = '2.4.8.2';
    function expressoMail1_2_upgrade2_4_8_2() {
        $GLOBALS['setup_info']['expressoMail1_2']['currentver'] = '2.5.0';
        return $GLOBALS['setup_info']['expressoMail1_2']['currentver'];
    }

    $test[] = '2.5.0';
    function expressoMail1_2_upgrade2_5_0() {
