...
$flags['currentapp'] = 'expressoMail1_2';
$flags['enable_nextmatchs_class'] = true;
$GLOBALS['phpgw_info']['flags'] = $flags;
...
echo '<script type="text/javascript"> template = "'.$_SESSION['phpgw_info']['expressoMail1_2']['user']['preferences']['common']['template_set'].'";</script>'; //Javascript global template
...
echo '<script type="text/javascript" src="../prototype/plugins/jquery/jquery.min.js" charset="utf-8"></script>';
...
echo '<script type="text/javascript" src="../library/ckeditor/ckeditor.js" charset="utf-8"></script>';
echo '<script type="text/javascript" src="../library/ckeditor/adapters/jquery.js" charset="utf-8"></script>';
echo '<script type="text/javascript" src="../prototype/plugins/jquery/jquery-ui.min.js" charset="utf-8"></script>';
echo '<script type="text/javascript" src="../prototype/plugins/countdown/jquery.countdown.min.js" charset="utf-8"></script>';
echo '<script type="text/javascript" src="../prototype/plugins/countdown/jquery.countdown-pt-BR.js" charset="utf-8"></script>';
echo '<script type="text/javascript" src="../prototype/plugins/fileupload/jquery.fileupload.js" charset="utf-8"></script>';
