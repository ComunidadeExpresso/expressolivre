...
<p>
    ...
    <tr>
	 	<td align="left" width="25%">
	  		<form name="form" method="POST" action="{add_action}">
	  			<input type="submit" value="{lang_add_email_lists}" {desabilitado} />
     	...
     	<td align="right" width="25%">
     		<form method="POST" action="{accounts_url}">
     			{lang_search}:
     			<input type="text" name="query" autocomplete="on" value="{query}" /><input type="submit" value="Pesquisar" />
      		</form>
     	</td>
    </tr>
   </table>
 ...
 <div align="center">
  <table border="0" width="95%">
   <tr bgcolor="{th_bg}">
<!--    <td width="20%">{lang_email_lists_uid}</td>-->
    <td width="30%">{lang_email_lists_names}</td>
    ...
    <td width="8%" align="center"><span title='Adm Listas'>{lang_adm}<span></td>
